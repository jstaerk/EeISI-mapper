...
SET JVM_ARGUMENTS= -Xmx512m -Dfile.encoding=UTF-8 -Dlogback.configurationFile=%APPLICATION_HOME%\conf\logback.xml -Deigor.configurationFile=%APPLICATION_HOME%\conf\eigor.properties
